...
const PortfolioSection = ({ projects }: { projects: FeaturedProjects[] }) => {
  ...
  const isImageLoading = !loadedImages[selectedProject._id];
                          ...
                          <Image
                            ...
                            onLoad={() => {
                              setLoadedImages((prev) => ({
                                ...prev,
                                [selectedProject._id]: true,
                              }));
                            }}
                          />
                          {/* Skeleton Loader */}
                          {isImageLoading && (
                            <div className="absolute inset-0 bg-[#252525]/40 rounded-xl overflow-hidden">
                              <motion.div
